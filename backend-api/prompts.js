...
- Add the internal links the brief lists; keep existing links that still make sense. Do NOT invent statistics, dates, prices, laws or case names — use only what is in the current content or the brief.
