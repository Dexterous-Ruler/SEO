...
- Do NOT ask for: divider/section-break lines, a "Related Resources / Further Reading" links list, an "email us" CTA, or a case-law/examples table unless there is REAL verified case law to cite (if unsure, don't ask for it — a placeholder like "no cases verified" is unacceptable). CTAs should point to the site's online booking form or phone, never email. Only suggest internal links to the site's genuinely existing pages.
...
- Weave the brief's internal links NATURALLY into the body prose where they are contextually relevant, and keep existing links that still make sense. Do NOT add a "Related Resources", "Further Reading", "Useful Links", "See Also" or any standalone list-of-links section — and remove one if the current content has it. Do NOT invent statistics, dates, prices, laws or case names — use only what is in the current content or the brief.
