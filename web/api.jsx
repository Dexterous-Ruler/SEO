...
(function () {
  ...
  window.SentinelAPI = {
    ...
    promptsList() { return engine("/prompts-list", {}); },
    promptSave(key, content, model, temperature) { return engine("/prompt-save", { key, content, model, temperature }); },
    promptReset(key) { return engine("/prompt-reset", { key }); },
